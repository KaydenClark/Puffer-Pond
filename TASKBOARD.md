...
|---|---|---|---|---|---|
| [S-007](specs/S-007-workbench-v2-3-lifecycle-update/SPEC.md) | TK-003: Run render, doctor, native and evaluator verification, then commit/push and prove remote recovery (in-progress) | planner-puffer-sol-high | TK-002 | Controls, legacy queue/proof, coverage matrix, stable specs, and canonical lifecycle helpers were reconciled without product source changes. | Finish native/lifecycle verification and publish the remotely recoverable planning checkpoint. |
| [S-006](specs/S-006-verification-and-static-delivery/SPEC.md) | TK-004: Add one repeatable browser acceptance runner for viewport overflow, controls, ripple, reduced motion, and forced visitor geometry (ready) | unassigned | none | Existing native, visual, deployment, and recovery proof was harvested; the smallest safe gap is a repeatable browser acceptance runner. | Claim TK-004 and add automated geometry/interaction proof without changing product behavior. |
