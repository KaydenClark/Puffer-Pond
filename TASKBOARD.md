...
|---|---|---|---|---|---|
| [S-006](specs/S-006-verification-and-static-delivery/SPEC.md) | TK-004: Add one repeatable browser acceptance runner for viewport overflow, controls, ripple, reduced motion, and forced visitor geometry (in-progress) | engineer-puffer | none | TK-004 fail-closed remediation and its pushed fresh-clone recovery procedure pass and are ready for re-audit. | Auditor re-reviews the immutable pushed remediation checkpoint before TK-004 closes. |
