...
|---|---|---|---|---|---|
| [S-006](specs/S-006-verification-and-static-delivery/SPEC.md) | TK-004: Add one repeatable browser acceptance runner for viewport overflow, controls, ripple, reduced motion, and forced visitor geometry (in-progress) | engineer-puffer | none | TK-004 headless browser checkpoint passes the full local gate and is ready for Auditor review. | Auditor reviews the immutable pushed checkpoint before TK-004 closes. |
