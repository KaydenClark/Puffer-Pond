...
|---|---|---|---|---|---|
| [S-006](specs/S-006-verification-and-static-delivery/SPEC.md) | TK-004: Add one repeatable browser acceptance runner for viewport overflow, controls, ripple, reduced motion, and forced visitor geometry (in-progress) | engineer-puffer | none | TK-004 positive and blocked-asset paths now share one fail-closed image-readiness predicate and pass the full gate. | Auditor performs the final immutable-checkpoint review before TK-004 closes. |
