...
| [S-006 - Verification And Static Delivery](specs/S-006-verification-and-static-delivery/SPEC.md) | Keep deterministic logic tests, production builds, browser acceptance evidence, GitHub Pages deployment, and remote recovery reproducible. | complete |
